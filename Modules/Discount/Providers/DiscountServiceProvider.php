...
use Modules\Discount\Repositories\ApplicationRepository;
use Modules\Discount\Repositories\BookingRepository;
use Modules\Discount\Repositories\DiscountRepository;

class DiscountServiceProvider extends ServiceProvider {

    protected string $moduleName = 'Discount';
    protected string $moduleNameLower = 'discount';
